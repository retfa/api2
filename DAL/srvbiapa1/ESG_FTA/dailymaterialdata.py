        ...
        try:
            ...
            if departments == "'all'":
                sql_query = text(f"""
                    ...
                    FROM [ESG_FTA].[dbo].[DailyMaterialData] fin
                    JOIN [ESG_FTA_MODIFY].[dbo].[DailyMaterialData] modi on
                    ...
                    AND fin.[SourceMaterialNo]	   = modi.[SourceMaterialNo]
                    AND fin.[SourceName]		   = modi.[SourceName]
                    AND fin.[SourceNo]			   = modi.[SourceNo]
