        ...
        try:
            ...
            if departments == "'all'":
                sql_query = text(f"""
                    ...
                    FROM [BI_FTA].[dbo].[BI_Analysis_Ind_Monthly] fin
                    JOIN [ESG_FTA_MODIFY].[dbo].[BI_Analysis_Ind_Monthly] modi on
                    fin.PERIOD_NAME	       = modi.PERIOD_NAME
