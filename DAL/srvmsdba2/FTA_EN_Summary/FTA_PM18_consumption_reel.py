...
@add_to_dict
class FTA_PM18_consumption_reel(Base):
    __tablename__ = 'FTA_PM18_consumption_reel'
...
class FTA_PM18_consumption_reelDal:
    def __init__(self):
...
FROM [FTA_EN_Summary].[dbo].[FTA_PM18_consumption_reel]
            """
