...
@add_to_dict
class FTA_PM21_consumption(Base):
    __tablename__ = 'FTA_PM21_consumption'
...
(
	...
	FROM [FTA_EN_Summary].[dbo].[FTA_PM21_consumption]
	WHERE category=:category
  	AND fta_dtm >:pdateStart
    AND fta_dtm<=:pdateEnd
)
